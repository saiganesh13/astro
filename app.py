...
def get_lahiri_ayanamsa(year):
    """
    Standard Lahiri (Chitrapaksha) ayanamsa - matches mainstream values
    Base for J2000.0 ≈ 23°51'11" = 23.8530556°
    Rate ≈ 50.2564 "/year (close to historical Newcomb/IAU used in Lahiri)
    Small quadratic term for better century-scale fit
    """
    t = year - 2000.0
    
    # Base at J2000.0 in degrees (most accepted value)
    base_deg = 23 + 51/60.0 + 11/3600.0  # 23.8530555556
    
    # Precession rate in arcseconds per year
    rate = 50.2564
    
    # Very small quadratic term (helps over long periods)
    quadratic = 0.000111 * t * t  # in arcseconds
    
    ayan_sec = rate * t + quadratic
